...
public class UserDetails extends AppCompatActivity {
    //fields
    EditText _txtWeight, _txtInchesCm, _txtFootM, _txtGoalWeight,_txtCalorie,_txtDaily;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Switches the measurement system to Imperial
        ...
        //Switches the measurement system to Metric
...
_btnSave.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        curWeight = _txtWeight.getText().toString().trim() +_tvCurWeight.getText().toString().trim();
